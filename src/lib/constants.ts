...
export const SUBSCRIPTION_PLANS = [
  ...
  { id: 'silver_plus', name: 'Silver Plus', price: 29,  period: '/day', commissionRate: 25, dispatchPriority: 'Moderate',  priorityLevel: 2, popular: false, features: ['25% platform commission — save 5%', 'Moderate dispatch priority', 'Silver Plus profile badge', 'Enhanced insurance coverage', 'Weekly BACS payout', '24/7 driver support'] },
  { id: 'gold',        name: 'Gold',        price: 49,  period: '/day', commissionRate: 20, dispatchPriority: 'High',      priorityLevel: 3, popular: true,  features: ['20% platform commission', 'High dispatch priority', 'Gold profile badge & trust seal', 'Premium insurance coverage', 'Bi-weekly BACS payout', 'Dedicated account manager'] },
