    ...
    <section className="py-14 bg-gray-50 border-t border-gray-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          ...
          {/* Image */}
          <div className="relative rounded-2xl overflow-hidden shadow-xl shadow-gray-900/10 order-2 lg:order-1">
            <img
              src={FEATURE_IMAGES.corporate}
              alt="Enterprise logistics"
              className="w-full h-56 lg:h-72 object-cover"
            />
            <div className="absolute inset-0 bg-gradient-to-t from-[#061539]/50 to-transparent" />
            <div className="absolute bottom-4 left-4 bg-white rounded-xl shadow-lg border border-gray-100 px-4 py-2.5">
              <p className="text-[#0A2463] text-2xl font-black leading-none">25%</p>
          ...
          <div className="order-1 lg:order-2">
            <span className="text-[#0A2463] text-xs font-bold tracking-[0.2em] uppercase mb-3 block">Enterprise</span>
            ...
            <div className="space-y-3 mb-6">
              {highlights.map((h, i) => (
                <div key={i} className="flex items-center gap-3">
                  <div className="w-8 h-8 bg-[#0A2463]/8 rounded-lg flex items-center justify-center shrink-0">
                    <h.icon className="w-4 h-4 text-[#0A2463]" />
                  </div>
            ...
            <button
              ...
              className="group inline-flex items-center gap-2.5 bg-[#0A2463] hover:bg-[#1B3A8C] text-white px-6 py-3 rounded-xl font-bold text-sm transition-all hover:-translate-y-0.5 hover:shadow-lg hover:shadow-[#0A2463]/25"
            >
              Explore Enterprise
