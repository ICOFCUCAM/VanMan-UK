    ...
    <>
      ...
      <div className="bg-[#061539] pt-24 pb-10 border-b border-white/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <span className="text-[#D4AF37] text-xs font-bold tracking-[0.2em] uppercase mb-3 block">Enterprise</span>
      ...
      {/* Portal CTA */}
      <section className="py-12 bg-[#061539] border-t border-white/5">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <button
            ...
            className="bg-[#D4AF37] hover:bg-[#C5A028] text-[#061539] px-7 py-3 rounded-xl font-bold text-sm transition-all hover:shadow-lg hover:shadow-[#D4AF37]/25"
          >
