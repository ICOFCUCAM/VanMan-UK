  ...
  return (
    <section className="py-12 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative rounded-2xl overflow-hidden bg-gradient-to-br from-[#0A2463] to-[#1a1065]">
          ...
          <div className="relative grid grid-cols-1 md:grid-cols-2 gap-0 items-stretch">
            ...
            <div className="p-8 sm:p-10">
              ...
              <h2 className="text-2xl sm:text-3xl font-black text-white mb-3 leading-tight">
                Students get <span className="text-[#D4AF37]">10% off</span> every booking
              </h2>
            ...
            <div className="relative flex items-center justify-center p-8 sm:p-10 border-t md:border-t-0 md:border-l border-white/8">
              <div className="text-center">
                <div className="w-18 h-18 bg-[#D4AF37]/15 border border-[#D4AF37]/20 rounded-2xl flex items-center justify-center mx-auto mb-4 p-4">
